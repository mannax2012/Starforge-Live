heavy_starforge_vendor_token = Creature:new {
	...
	lootGroups = {
		{
			groups = {
				{group = "heavy_starforge_vendor_token", chance = 10000000},
			},
            lootChance = 2000000
		}
	},
...
CreatureTemplates:addCreatureTemplate(heavy_starforge_vendor_token, "heavy_starforge_vendor_token")
