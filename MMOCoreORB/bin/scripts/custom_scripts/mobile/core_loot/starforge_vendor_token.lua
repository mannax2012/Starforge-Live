starforge_vendor_token = Creature:new {
	...
	lootGroups = {
		{
			groups = {
				{group = "starforge_vendor_token", chance = 10000000},
			},
            lootChance = 500000
		}
	},
...
CreatureTemplates:addCreatureTemplate(starforge_vendor_token, "starforge_vendor_token")
