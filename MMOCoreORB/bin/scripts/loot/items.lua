...
includeFile("items/custom/tusken_bracer_r_schematic.lua")
includeFile("items/custom/tusken_gloves_schematic.lua")
includeFile("items/custom/tusken_hat_schematic.lua")
includeFile("items/custom/tusken_robe_s01_schematic.lua")
includeFile("items/custom/tusken_robe_s02_schematic.lua")
