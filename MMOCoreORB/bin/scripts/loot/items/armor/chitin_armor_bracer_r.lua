chitin_armor_bracer_r = {
	...
	directObjectTemplate = "object/tangible/wearables/armor/chitin/armor_chitin_s01_bracer_r.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("chitin_armor_bracer_r", chitin_armor_bracer_r)
