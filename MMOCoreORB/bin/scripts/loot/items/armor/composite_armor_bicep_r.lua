composite_armor_bicep_r = {
	...
	directObjectTemplate = "object/tangible/wearables/armor/composite/armor_composite_bicep_r.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("composite_armor_bicep_r", composite_armor_bicep_r)
