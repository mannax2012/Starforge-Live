composite_armor_bracer_l = {
	...
	directObjectTemplate = "object/tangible/wearables/armor/composite/armor_composite_bracer_l.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("composite_armor_bracer_l", composite_armor_bracer_l)
