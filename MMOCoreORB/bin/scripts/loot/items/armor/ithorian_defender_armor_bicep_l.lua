ithorian_defender_armor_bicep_l = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_bicep_l.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("ithorian_defender_armor_bicep_l", ithorian_defender_armor_bicep_l)
