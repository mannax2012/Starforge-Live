ithorian_defender_armor_bracer_r = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_bracer_r.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("ithorian_defender_armor_bracer_r", ithorian_defender_armor_bracer_r)
