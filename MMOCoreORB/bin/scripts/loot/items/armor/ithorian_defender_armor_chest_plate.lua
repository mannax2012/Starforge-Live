ithorian_defender_armor_chest_plate = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_chest_plate.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("ithorian_defender_armor_chest_plate", ithorian_defender_armor_chest_plate)
