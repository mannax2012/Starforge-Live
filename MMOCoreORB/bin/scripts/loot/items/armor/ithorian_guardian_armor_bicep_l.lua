ithorian_guardian_armor_bicep_l = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/ithorian_guardian/ith_armor_s02_bicep_l.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("ithorian_guardian_armor_bicep_l", ithorian_guardian_armor_bicep_l)
