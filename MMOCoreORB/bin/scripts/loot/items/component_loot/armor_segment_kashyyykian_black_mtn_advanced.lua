armor_segment_kashyyykian_black_mtn_advanced = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/component/armor/armor_segment_kashyyykian_black_mtn_advanced.iff",
	craftingValues = {
...
addLootItemTemplate("armor_segment_kashyyykian_black_mtn_advanced", armor_segment_kashyyykian_black_mtn_advanced)
