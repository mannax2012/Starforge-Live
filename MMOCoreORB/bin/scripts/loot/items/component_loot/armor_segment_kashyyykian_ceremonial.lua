armor_segment_kashyyykian_ceremonial = {
	...
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/component/armor/armor_segment_kashyyykian_ceremonial.iff",
	craftingValues = {
...
addLootItemTemplate("armor_segment_kashyyykian_ceremonial", armor_segment_kashyyykian_ceremonial)
