armor_segment_kashyyykian_hunting = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/component/armor/armor_segment_kashyyykian_hunting.iff",
	craftingValues = {
...
addLootItemTemplate("armor_segment_kashyyykian_hunting", armor_segment_kashyyykian_hunting)
