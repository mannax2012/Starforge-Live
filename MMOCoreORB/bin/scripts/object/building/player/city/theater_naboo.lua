...
object_building_player_city_theater_naboo = object_building_player_city_shared_theater_naboo:new {
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address_naboo.iff", x = 11.1, z = 3.08, y = -14, ox = 0, oy = -0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
