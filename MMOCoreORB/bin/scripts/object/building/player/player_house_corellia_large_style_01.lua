...
object_building_player_player_house_corellia_large_style_01 = object_building_player_shared_player_house_corellia_large_style_01:new {
	...
	childObjects = {
		{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = 6, z = 2.25, y = 13.75, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = 6, z = 2.25, y = 13.75, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
