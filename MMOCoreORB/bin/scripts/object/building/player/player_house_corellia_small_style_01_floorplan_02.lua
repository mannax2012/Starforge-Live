...
object_building_player_player_house_corellia_small_style_01_floorplan_02 = object_building_player_shared_player_house_corellia_small_style_01_floorplan_02:new {
	...
	childObjects = {
		{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = -4.05, z = 2.4, y = 8.25, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1},
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = -4.05, z = 2.4, y = 8.25, ox = 0, oy = 0.707107, oz = 0, ow = 0.707107, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
