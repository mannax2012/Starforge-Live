...
object_building_player_player_house_generic_large_style_02 = object_building_player_shared_player_house_generic_large_style_02:new {
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address.iff", x = -6.07, z = 2.5, y = 15.26, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
