...
object_building_player_player_house_generic_medium_style_02 = object_building_player_shared_player_house_generic_medium_style_02:new {
	...
	childObjects = {
		{templateFile = "object/tangible/sign/player/house_address.iff", x = 2.55, z = 2.25, y = 7.52, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1},
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address.iff", x = 2.55, z = 2.25, y = 7.52, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
