...
object_building_player_player_house_generic_small_style_01 = object_building_player_shared_player_house_generic_small_style_01:new {
	lotSize = 1,
	...
	childObjects = {
		{templateFile = "object/tangible/sign/player/house_address.iff", x = -4.29, z = 2.25, y = 8.2, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1},
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address.iff", x = -4.29, z = 2.25, y = 8.2, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
...
ObjectTemplates:addTemplate(object_building_player_player_house_generic_small_style_01, "object/building/player/player_house_generic_small_style_01.iff")
