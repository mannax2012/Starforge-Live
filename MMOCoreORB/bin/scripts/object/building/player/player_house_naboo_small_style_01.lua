...
object_building_player_player_house_naboo_small_style_01 = object_building_player_shared_player_house_naboo_small_style_01:new {
	...
	childObjects = {
		{templateFile = "object/tangible/sign/player/house_address_naboo.iff", x = 1.5, z = 2.25, y = -8.4, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1},
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address_naboo.iff", x = 1.5, z = 2.25, y = -8.4, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
