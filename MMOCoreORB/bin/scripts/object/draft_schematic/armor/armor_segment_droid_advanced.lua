...
object_draft_schematic_armor_armor_segment_droid_advanced = object_draft_schematic_armor_shared_armor_segment_droid_advanced:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Droid Upgrade Module Segment: MKII Advanced Programming",
	...
	targetTemplate = "object/tangible/component/armor/armor_segment_droid_advanced.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_segment_droid_advanced, "object/draft_schematic/armor/armor_segment_droid_advanced.iff")
