...
object_draft_schematic_chemistry_medpack_enhance_health_d = object_draft_schematic_chemistry_shared_medpack_enhance_health_d:new {
	...
	customObjectName = "Enhance Health Medpack - D",
...
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_health_d, "object/draft_schematic/chemistry/medpack_enhance_health_d.iff")
