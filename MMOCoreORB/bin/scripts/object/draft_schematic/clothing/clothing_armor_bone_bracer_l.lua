...
object_draft_schematic_clothing_clothing_armor_bone_bracer_l = object_draft_schematic_clothing_shared_clothing_armor_bone_bracer_l:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/bone/armor_bone_s01_bracer_l.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_bone_bracer_l, "object/draft_schematic/clothing/clothing_armor_bone_bracer_l.iff")
