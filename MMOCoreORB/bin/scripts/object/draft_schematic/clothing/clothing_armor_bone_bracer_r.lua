...
object_draft_schematic_clothing_clothing_armor_bone_bracer_r = object_draft_schematic_clothing_shared_clothing_armor_bone_bracer_r:new {
   ...
   resourceQuantities = {15, 15, 15, 10, 5, 5, 1, 1, 1, 1},
   contribution = {100, 100, 100, 100, 100, 100, 100, 100, 100, 100},


   targetTemplate = "object/tangible/wearables/armor/bone/armor_bone_s01_bracer_r.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_bone_bracer_r, "object/draft_schematic/clothing/clothing_armor_bone_bracer_r.iff")
