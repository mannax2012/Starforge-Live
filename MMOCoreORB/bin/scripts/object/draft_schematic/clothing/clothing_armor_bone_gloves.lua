...
object_draft_schematic_clothing_clothing_armor_bone_gloves = object_draft_schematic_clothing_shared_clothing_armor_bone_gloves:new {
   ...
   resourceQuantities = {10, 10, 10, 5, 3, 5, 1, 1, 1, 1},
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_bone_gloves, "object/draft_schematic/clothing/clothing_armor_bone_gloves.iff")
