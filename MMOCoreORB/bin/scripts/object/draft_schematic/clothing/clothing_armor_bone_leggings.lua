...
object_draft_schematic_clothing_clothing_armor_bone_leggings = object_draft_schematic_clothing_shared_clothing_armor_bone_leggings:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/bone/armor_bone_s01_leggings.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_bone_leggings, "object/draft_schematic/clothing/clothing_armor_bone_leggings.iff")
