...
object_draft_schematic_clothing_clothing_armor_chitin_boots = object_draft_schematic_clothing_shared_clothing_armor_chitin_boots:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/chitin/armor_chitin_s01_boots.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_chitin_boots, "object/draft_schematic/clothing/clothing_armor_chitin_boots.iff")
