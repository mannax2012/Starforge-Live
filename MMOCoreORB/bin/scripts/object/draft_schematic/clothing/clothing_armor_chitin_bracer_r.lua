...
object_draft_schematic_clothing_clothing_armor_chitin_bracer_r = object_draft_schematic_clothing_shared_clothing_armor_chitin_bracer_r:new {
   ...
   customObjectName = "Chitin Armor Right Bracer",
   ...
   targetTemplate = "object/tangible/wearables/armor/chitin/armor_chitin_s01_bracer_r.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_chitin_bracer_r, "object/draft_schematic/clothing/clothing_armor_chitin_bracer_r.iff")
