...
object_draft_schematic_clothing_clothing_armor_chitin_chest = object_draft_schematic_clothing_shared_clothing_armor_chitin_chest:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/chitin/armor_chitin_s01_chest_plate.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_chitin_chest, "object/draft_schematic/clothing/clothing_armor_chitin_chest.iff")
