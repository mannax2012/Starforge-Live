...
object_draft_schematic_clothing_clothing_armor_composite_gloves = object_draft_schematic_clothing_shared_clothing_armor_composite_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Composite Armor Gloves",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_composite_gloves, "object/draft_schematic/clothing/clothing_armor_composite_gloves.iff")
