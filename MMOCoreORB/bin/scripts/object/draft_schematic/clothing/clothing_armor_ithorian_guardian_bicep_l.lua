...
object_draft_schematic_clothing_clothing_armor_ithorian_guardian_bicep_l = object_draft_schematic_clothing_shared_clothing_armor_ithorian_guardian_bicep_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Ithorian Guardian Bicep (Left)",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ithorian_guardian_bicep_l, "object/draft_schematic/clothing/clothing_armor_ithorian_guardian_bicep_l.iff")
