...
object_draft_schematic_clothing_clothing_armor_ithorian_guardian_gloves = object_draft_schematic_clothing_shared_clothing_armor_ithorian_guardian_gloves:new {
   ...
   resourceQuantities = {15, 15, 15, 5, 5, 5, 1, 1, 1},
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ithorian_guardian_gloves, "object/draft_schematic/clothing/clothing_armor_ithorian_guardian_gloves.iff")
