...
object_draft_schematic_clothing_clothing_armor_ithorian_sentinel_chest = object_draft_schematic_clothing_shared_clothing_armor_ithorian_sentinel_chest:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Ithorian Sentinel Chest Plate",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ithorian_sentinel_chest, "object/draft_schematic/clothing/clothing_armor_ithorian_sentinel_chest.iff")
