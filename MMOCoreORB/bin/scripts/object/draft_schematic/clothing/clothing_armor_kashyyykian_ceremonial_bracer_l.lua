...
object_draft_schematic_clothing_clothing_armor_kashyyykian_ceremonial_bracer_l = object_draft_schematic_clothing_shared_clothing_armor_kashyyykian_ceremonial_bracer_l:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/kashyyykian_ceremonial/armor_kashyyykian_ceremonial_bracer_l.iff",
