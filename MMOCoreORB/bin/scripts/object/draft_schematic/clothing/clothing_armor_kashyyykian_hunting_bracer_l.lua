...
object_draft_schematic_clothing_clothing_armor_kashyyykian_hunting_bracer_l = object_draft_schematic_clothing_shared_clothing_armor_kashyyykian_hunting_bracer_l:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/kashyyykian_hunting/armor_kashyyykian_hunting_bracer_l.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_kashyyykian_hunting_bracer_l, "object/draft_schematic/clothing/clothing_armor_kashyyykian_hunting_bracer_l.iff")
