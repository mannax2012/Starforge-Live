...
object_draft_schematic_clothing_clothing_armor_kashyyykian_hunting_bracer_r = object_draft_schematic_clothing_shared_clothing_armor_kashyyykian_hunting_bracer_r:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/kashyyykian_hunting/armor_kashyyykian_hunting_bracer_r.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_kashyyykian_hunting_bracer_r, "object/draft_schematic/clothing/clothing_armor_kashyyykian_hunting_bracer_r.iff")
