...
object_draft_schematic_clothing_clothing_armor_kashyyykian_hunting_chest = object_draft_schematic_clothing_shared_clothing_armor_kashyyykian_hunting_chest:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Kashyyykian Hunting Chest Plate",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_kashyyykian_hunting_chest, "object/draft_schematic/clothing/clothing_armor_kashyyykian_hunting_chest.iff")
