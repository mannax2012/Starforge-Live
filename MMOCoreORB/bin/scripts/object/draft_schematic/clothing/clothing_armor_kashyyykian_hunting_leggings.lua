...
object_draft_schematic_clothing_clothing_armor_kashyyykian_hunting_leggings = object_draft_schematic_clothing_shared_clothing_armor_kashyyykian_hunting_leggings:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/kashyyykian_hunting/armor_kashyyykian_hunting_leggings.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_kashyyykian_hunting_leggings, "object/draft_schematic/clothing/clothing_armor_kashyyykian_hunting_leggings.iff")
