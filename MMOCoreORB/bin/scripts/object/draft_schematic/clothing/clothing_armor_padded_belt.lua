...
object_draft_schematic_clothing_clothing_armor_padded_belt = object_draft_schematic_clothing_shared_clothing_armor_padded_belt:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_padded_belt, "object/draft_schematic/clothing/clothing_armor_padded_belt.iff")
