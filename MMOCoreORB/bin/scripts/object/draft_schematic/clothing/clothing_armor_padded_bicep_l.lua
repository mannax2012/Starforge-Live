...
object_draft_schematic_clothing_clothing_armor_padded_bicep_l = object_draft_schematic_clothing_shared_clothing_armor_padded_bicep_l:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/padded/armor_padded_s01_bicep_l.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_padded_bicep_l, "object/draft_schematic/clothing/clothing_armor_padded_bicep_l.iff")
