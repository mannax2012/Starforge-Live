...
object_draft_schematic_clothing_clothing_armor_padded_bicep_r = object_draft_schematic_clothing_shared_clothing_armor_padded_bicep_r:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/padded/armor_padded_s01_bicep_r.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_padded_bicep_r, "object/draft_schematic/clothing/clothing_armor_padded_bicep_r.iff")
