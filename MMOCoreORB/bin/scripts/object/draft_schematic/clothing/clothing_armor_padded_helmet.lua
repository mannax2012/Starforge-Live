...
object_draft_schematic_clothing_clothing_armor_padded_helmet = object_draft_schematic_clothing_shared_clothing_armor_padded_helmet:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Padded Armor Helmet",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_padded_helmet, "object/draft_schematic/clothing/clothing_armor_padded_helmet.iff")
