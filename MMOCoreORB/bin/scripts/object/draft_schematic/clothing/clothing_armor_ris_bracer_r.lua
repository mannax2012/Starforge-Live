...
object_draft_schematic_clothing_clothing_armor_ris_bracer_r = object_draft_schematic_clothing_shared_clothing_armor_ris_bracer_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "R.I.S. Armor Right Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ris_bracer_r, "object/draft_schematic/clothing/clothing_armor_ris_bracer_r.iff")
