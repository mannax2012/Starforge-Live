...
object_draft_schematic_clothing_clothing_armor_ris_chest_plate = object_draft_schematic_clothing_shared_clothing_armor_ris_chest_plate:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "R.I.S. Armor Chest Plate",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ris_chest_plate, "object/draft_schematic/clothing/clothing_armor_ris_chest_plate.iff")
