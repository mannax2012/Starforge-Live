...
object_draft_schematic_clothing_clothing_armor_ris_gloves = object_draft_schematic_clothing_shared_clothing_armor_ris_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "R.I.S. Armor Gloves",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ris_gloves, "object/draft_schematic/clothing/clothing_armor_ris_gloves.iff")
