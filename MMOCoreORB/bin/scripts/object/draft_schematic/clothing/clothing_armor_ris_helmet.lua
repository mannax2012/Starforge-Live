...
object_draft_schematic_clothing_clothing_armor_ris_helmet = object_draft_schematic_clothing_shared_clothing_armor_ris_helmet:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "R.I.S Armor Helmet",
