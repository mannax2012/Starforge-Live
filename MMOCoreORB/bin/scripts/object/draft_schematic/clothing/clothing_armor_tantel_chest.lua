...
object_draft_schematic_clothing_clothing_armor_tantel_chest = object_draft_schematic_clothing_shared_clothing_armor_tantel_chest:new {
   ...
   resourceQuantities = {40, 40, 40, 25, 25, 25, 4, 1, 1},
   contribution = {100, 100, 100, 100, 100, 100, 100, 100, 100},


   targetTemplate = "object/tangible/wearables/armor/tantel/armor_tantel_skreej_chest_plate.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_tantel_chest, "object/draft_schematic/clothing/clothing_armor_tantel_chest.iff")
