...
object_draft_schematic_clothing_clothing_armor_tantel_helmet = object_draft_schematic_clothing_shared_clothing_armor_tantel_helmet:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/tantel/armor_tantel_skreej_helmet.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_tantel_helmet, "object/draft_schematic/clothing/clothing_armor_tantel_helmet.iff")
