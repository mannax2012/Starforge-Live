...
object_draft_schematic_clothing_clothing_armor_ubese_boots = object_draft_schematic_clothing_shared_clothing_armor_ubese_boots:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/ubese/armor_ubese_boots.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ubese_boots, "object/draft_schematic/clothing/clothing_armor_ubese_boots.iff")
