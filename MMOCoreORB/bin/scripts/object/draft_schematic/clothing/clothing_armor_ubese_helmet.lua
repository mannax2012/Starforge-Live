...
object_draft_schematic_clothing_clothing_armor_ubese_helmet = object_draft_schematic_clothing_shared_clothing_armor_ubese_helmet:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/ubese/armor_ubese_helmet.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ubese_helmet, "object/draft_schematic/clothing/clothing_armor_ubese_helmet.iff")
