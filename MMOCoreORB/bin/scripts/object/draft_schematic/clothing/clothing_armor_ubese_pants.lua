...
object_draft_schematic_clothing_clothing_armor_ubese_pants = object_draft_schematic_clothing_shared_clothing_armor_ubese_pants:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/ubese/armor_ubese_pants.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_ubese_pants, "object/draft_schematic/clothing/clothing_armor_ubese_pants.iff")
