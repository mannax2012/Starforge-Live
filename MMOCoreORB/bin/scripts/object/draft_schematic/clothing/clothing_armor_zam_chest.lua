...
object_draft_schematic_clothing_clothing_armor_zam_chest = object_draft_schematic_clothing_shared_clothing_armor_zam_chest:new {
   ...
   customizationDefaults = {108, 82, 20},
   ...
   targetTemplate = "object/tangible/wearables/armor/zam/armor_zam_wesell_chest_plate.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_zam_chest, "object/draft_schematic/clothing/clothing_armor_zam_chest.iff")
