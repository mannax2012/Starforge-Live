...
object_draft_schematic_clothing_clothing_backpack_field_04 = object_draft_schematic_clothing_shared_clothing_backpack_field_04:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Tech Pack",
