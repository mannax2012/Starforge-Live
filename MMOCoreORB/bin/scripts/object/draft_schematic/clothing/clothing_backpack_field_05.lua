...
object_draft_schematic_clothing_clothing_backpack_field_05 = object_draft_schematic_clothing_shared_clothing_backpack_field_05:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Bounty Hunter Pack",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_backpack_field_05, "object/draft_schematic/clothing/clothing_backpack_field_05.iff")
