...
object_draft_schematic_clothing_clothing_bandolier_field_04 = object_draft_schematic_clothing_shared_clothing_bandolier_field_04:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Multipocket Bandolier",
   ...
   targetTemplate = "object/tangible/wearables/bandolier/bandolier_s04.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_bandolier_field_04, "object/draft_schematic/clothing/clothing_bandolier_field_04.iff")
