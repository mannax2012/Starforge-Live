...
object_draft_schematic_clothing_clothing_bodysuit_casual_08 = object_draft_schematic_clothing_shared_clothing_bodysuit_casual_08:new {
   ...
   targetTemplate = "object/tangible/wearables/bodysuit/bodysuit_s08.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_bodysuit_casual_08, "object/draft_schematic/clothing/clothing_bodysuit_casual_08.iff")
