...
object_draft_schematic_clothing_clothing_bodysuit_casual_12 = object_draft_schematic_clothing_shared_clothing_bodysuit_casual_12:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Trader\'s Flightsuit",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_bodysuit_casual_12, "object/draft_schematic/clothing/clothing_bodysuit_casual_12.iff")
