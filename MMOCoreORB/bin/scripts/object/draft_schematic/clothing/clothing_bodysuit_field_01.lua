...
object_draft_schematic_clothing_clothing_bodysuit_field_01 = object_draft_schematic_clothing_shared_clothing_bodysuit_field_01:new {
   ...
   targetTemplate = "object/tangible/wearables/bodysuit/bodysuit_s01.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_bodysuit_field_01, "object/draft_schematic/clothing/clothing_bodysuit_field_01.iff")
