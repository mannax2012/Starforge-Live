...
object_draft_schematic_clothing_clothing_bodysuit_field_14 = object_draft_schematic_clothing_shared_clothing_bodysuit_field_14:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Fighter Flightsuit",
   ...
   targetTemplate = "object/tangible/wearables/bodysuit/bodysuit_s14.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_bodysuit_field_14, "object/draft_schematic/clothing/clothing_bodysuit_field_14.iff")
