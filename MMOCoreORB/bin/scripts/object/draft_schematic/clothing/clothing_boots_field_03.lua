...
object_draft_schematic_clothing_clothing_boots_field_03 = object_draft_schematic_clothing_shared_clothing_boots_field_03:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Wrapped Boots",
   ...
   targetTemplate = "object/tangible/wearables/boots/boots_s03.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_boots_field_03, "object/draft_schematic/clothing/clothing_boots_field_03.iff")
