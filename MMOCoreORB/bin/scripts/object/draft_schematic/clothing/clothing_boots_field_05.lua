...
object_draft_schematic_clothing_clothing_boots_field_05 = object_draft_schematic_clothing_shared_clothing_boots_field_05:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Sturdy Boots",
   ...
   targetTemplate = "object/tangible/wearables/boots/boots_s05.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_boots_field_05, "object/draft_schematic/clothing/clothing_boots_field_05.iff")
