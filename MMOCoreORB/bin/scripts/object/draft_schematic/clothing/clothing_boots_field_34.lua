...
object_draft_schematic_clothing_clothing_boots_field_34 = object_draft_schematic_clothing_shared_clothing_boots_field_34:new {
   ...
   targetTemplate = "object/tangible/wearables/boots/boots_s34.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_boots_field_34, "object/draft_schematic/clothing/clothing_boots_field_34.iff")
