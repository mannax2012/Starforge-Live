...
object_draft_schematic_clothing_clothing_dress_casual_05 = object_draft_schematic_clothing_shared_clothing_dress_casual_05:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Decorative Dress",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s05.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_casual_05, "object/draft_schematic/clothing/clothing_dress_casual_05.iff")
