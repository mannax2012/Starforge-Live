...
object_draft_schematic_clothing_clothing_dress_casual_07 = object_draft_schematic_clothing_shared_clothing_dress_casual_07:new {
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s07.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_casual_07, "object/draft_schematic/clothing/clothing_dress_casual_07.iff")
