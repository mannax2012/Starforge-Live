...
object_draft_schematic_clothing_clothing_dress_casual_09 = object_draft_schematic_clothing_shared_clothing_dress_casual_09:new {
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s09.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_casual_09, "object/draft_schematic/clothing/clothing_dress_casual_09.iff")
