...
object_draft_schematic_clothing_clothing_dress_casual_12 = object_draft_schematic_clothing_shared_clothing_dress_casual_12:new {
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s12.iff",
