...
object_draft_schematic_clothing_clothing_dress_formal_08 = object_draft_schematic_clothing_shared_clothing_dress_formal_08:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Exotic Leotard",
   ...
   resourceQuantities = {60, 3, 2, 50, 3, 2},
   contribution = {100, 100, 100, 100, 100, 100},


   targetTemplate = "object/tangible/wearables/dress/dress_s08.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_08, "object/draft_schematic/clothing/clothing_dress_formal_08.iff")
