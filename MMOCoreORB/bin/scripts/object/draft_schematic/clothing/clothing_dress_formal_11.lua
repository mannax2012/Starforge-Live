...
object_draft_schematic_clothing_clothing_dress_formal_11 = object_draft_schematic_clothing_shared_clothing_dress_formal_11:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Robe",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s11.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_11, "object/draft_schematic/clothing/clothing_dress_formal_11.iff")
