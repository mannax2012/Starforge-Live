...
object_draft_schematic_clothing_clothing_dress_formal_13 = object_draft_schematic_clothing_shared_clothing_dress_formal_13:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Smock",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s13.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_13, "object/draft_schematic/clothing/clothing_dress_formal_13.iff")
