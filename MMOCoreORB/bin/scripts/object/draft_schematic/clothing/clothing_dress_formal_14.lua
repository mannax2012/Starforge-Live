...
object_draft_schematic_clothing_clothing_dress_formal_14 = object_draft_schematic_clothing_shared_clothing_dress_formal_14:new {
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s14.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_14, "object/draft_schematic/clothing/clothing_dress_formal_14.iff")
