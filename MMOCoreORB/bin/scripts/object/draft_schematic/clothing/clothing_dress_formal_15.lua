...
object_draft_schematic_clothing_clothing_dress_formal_15 = object_draft_schematic_clothing_shared_clothing_dress_formal_15:new {
   ...
   resourceQuantities = {2, 3, 3, 50, 3, 60},
   contribution = {100, 100, 100, 100, 100, 100},


   targetTemplate = "object/tangible/wearables/dress/dress_s15.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_15, "object/draft_schematic/clothing/clothing_dress_formal_15.iff")
