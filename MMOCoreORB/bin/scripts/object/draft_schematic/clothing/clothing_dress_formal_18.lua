...
object_draft_schematic_clothing_clothing_dress_formal_18 = object_draft_schematic_clothing_shared_clothing_dress_formal_18:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Administrator\'s Robe",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s18.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_18, "object/draft_schematic/clothing/clothing_dress_formal_18.iff")
