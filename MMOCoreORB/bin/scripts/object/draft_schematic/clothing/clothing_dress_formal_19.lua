...
object_draft_schematic_clothing_clothing_dress_formal_19 = object_draft_schematic_clothing_shared_clothing_dress_formal_19:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Doctor\'s Dress",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s19.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_19, "object/draft_schematic/clothing/clothing_dress_formal_19.iff")
