...
object_draft_schematic_clothing_clothing_dress_formal_23 = object_draft_schematic_clothing_shared_clothing_dress_formal_23:new {
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s23.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_23, "object/draft_schematic/clothing/clothing_dress_formal_23.iff")
