...
object_draft_schematic_clothing_clothing_dress_formal_26 = object_draft_schematic_clothing_shared_clothing_dress_formal_26:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Frock",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s26.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_26, "object/draft_schematic/clothing/clothing_dress_formal_26.iff")
