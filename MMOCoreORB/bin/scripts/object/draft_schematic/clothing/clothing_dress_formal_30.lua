...
object_draft_schematic_clothing_clothing_dress_formal_30 = object_draft_schematic_clothing_shared_clothing_dress_formal_30:new {
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s30.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_30, "object/draft_schematic/clothing/clothing_dress_formal_30.iff")
