...
object_draft_schematic_clothing_clothing_dress_formal_31 = object_draft_schematic_clothing_shared_clothing_dress_formal_31:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Longsleeve Gown",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s31.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_31, "object/draft_schematic/clothing/clothing_dress_formal_31.iff")
