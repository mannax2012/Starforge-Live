...
object_draft_schematic_clothing_clothing_dress_formal_32 = object_draft_schematic_clothing_shared_clothing_dress_formal_32:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Intricate Dress",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s32.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_32, "object/draft_schematic/clothing/clothing_dress_formal_32.iff")
