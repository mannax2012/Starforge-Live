...
object_draft_schematic_clothing_clothing_dress_formal_34 = object_draft_schematic_clothing_shared_clothing_dress_formal_34:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Luxurious Gown",
   ...
   targetTemplate = "object/tangible/wearables/dress/dress_s34.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_dress_formal_34, "object/draft_schematic/clothing/clothing_dress_formal_34.iff")
