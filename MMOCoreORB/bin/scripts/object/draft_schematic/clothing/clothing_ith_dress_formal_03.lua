...
object_draft_schematic_clothing_clothing_ith_dress_formal_03 = object_draft_schematic_clothing_shared_clothing_ith_dress_formal_03:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Ithorian Elder\'s Dress",
   ...
   targetTemplate = "object/tangible/wearables/ithorian/ith_dress_s03.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_ith_dress_formal_03, "object/draft_schematic/clothing/clothing_ith_dress_formal_03.iff")
