...
object_draft_schematic_clothing_clothing_ith_dress_formal_04 = object_draft_schematic_clothing_shared_clothing_ith_dress_formal_04:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Ithorian Dress Jacket",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_ith_dress_formal_04, "object/draft_schematic/clothing/clothing_ith_dress_formal_04.iff")
