...
object_draft_schematic_clothing_clothing_ith_jewelry_necklace_03 = object_draft_schematic_clothing_shared_clothing_ith_jewelry_necklace_03:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Ithorian Crested Neckpiece",
   ...
   targetTemplate = "object/tangible/wearables/ithorian/ith_necklace_s03.iff",
