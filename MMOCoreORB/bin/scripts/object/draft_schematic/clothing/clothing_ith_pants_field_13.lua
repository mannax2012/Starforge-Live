...
object_draft_schematic_clothing_clothing_ith_pants_field_13 = object_draft_schematic_clothing_shared_clothing_ith_pants_field_13:new {
   ...
   targetTemplate = "object/tangible/wearables/ithorian/ith_pants_s13.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_ith_pants_field_13, "object/draft_schematic/clothing/clothing_ith_pants_field_13.iff")
