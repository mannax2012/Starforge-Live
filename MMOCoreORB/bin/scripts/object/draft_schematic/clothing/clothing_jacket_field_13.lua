...
object_draft_schematic_clothing_clothing_jacket_field_13 = object_draft_schematic_clothing_shared_clothing_jacket_field_13:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Reinforced Jacket",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_jacket_field_13, "object/draft_schematic/clothing/clothing_jacket_field_13.iff")
