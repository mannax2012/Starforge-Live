...
object_draft_schematic_clothing_clothing_jacket_formal_25 = object_draft_schematic_clothing_shared_clothing_jacket_formal_25:new {
   ...
   customizationDefaults = {27, 90, 63},
   ...
   targetTemplate = "object/tangible/wearables/jacket/jacket_s25.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_jacket_formal_25, "object/draft_schematic/clothing/clothing_jacket_formal_25.iff")
