...
object_draft_schematic_clothing_clothing_pants_casual_11 = object_draft_schematic_clothing_shared_clothing_pants_casual_11:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Desert Crawlers",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s11.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_casual_11, "object/draft_schematic/clothing/clothing_pants_casual_11.iff")
