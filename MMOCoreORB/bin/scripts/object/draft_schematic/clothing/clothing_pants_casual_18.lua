...
object_draft_schematic_clothing_clothing_pants_casual_18 = object_draft_schematic_clothing_shared_clothing_pants_casual_18:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Short Skirt",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s18.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_casual_18, "object/draft_schematic/clothing/clothing_pants_casual_18.iff")
