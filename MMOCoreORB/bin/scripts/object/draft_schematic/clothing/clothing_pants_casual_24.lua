...
object_draft_schematic_clothing_clothing_pants_casual_24 = object_draft_schematic_clothing_shared_clothing_pants_casual_24:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Pantaloons",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s24.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_casual_24, "object/draft_schematic/clothing/clothing_pants_casual_24.iff")
