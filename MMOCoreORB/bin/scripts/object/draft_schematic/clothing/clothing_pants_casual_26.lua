...
object_draft_schematic_clothing_clothing_pants_casual_26 = object_draft_schematic_clothing_shared_clothing_pants_casual_26:new {
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s26.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_casual_26, "object/draft_schematic/clothing/clothing_pants_casual_26.iff")
