...
object_draft_schematic_clothing_clothing_pants_field_04 = object_draft_schematic_clothing_shared_clothing_pants_field_04:new {
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s04.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_field_04, "object/draft_schematic/clothing/clothing_pants_field_04.iff")
