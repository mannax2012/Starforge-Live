...
object_draft_schematic_clothing_clothing_pants_field_14 = object_draft_schematic_clothing_shared_clothing_pants_field_14:new {
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s14.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_field_14, "object/draft_schematic/clothing/clothing_pants_field_14.iff")
