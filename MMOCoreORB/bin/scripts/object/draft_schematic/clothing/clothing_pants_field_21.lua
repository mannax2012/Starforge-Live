...
object_draft_schematic_clothing_clothing_pants_field_21 = object_draft_schematic_clothing_shared_clothing_pants_field_21:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Paramilitary Camos",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s21.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_field_21, "object/draft_schematic/clothing/clothing_pants_field_21.iff")
