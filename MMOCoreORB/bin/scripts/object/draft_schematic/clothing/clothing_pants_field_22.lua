...
object_draft_schematic_clothing_clothing_pants_field_22 = object_draft_schematic_clothing_shared_clothing_pants_field_22:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Infiltrator Leggings",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s22.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_field_22, "object/draft_schematic/clothing/clothing_pants_field_22.iff")
