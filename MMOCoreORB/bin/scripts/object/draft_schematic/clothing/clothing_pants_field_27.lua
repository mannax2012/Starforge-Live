...
object_draft_schematic_clothing_clothing_pants_field_27 = object_draft_schematic_clothing_shared_clothing_pants_field_27:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Pocketed Shorts",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s27.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_field_27, "object/draft_schematic/clothing/clothing_pants_field_27.iff")
