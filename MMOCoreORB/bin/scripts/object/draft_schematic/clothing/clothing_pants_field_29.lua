...
object_draft_schematic_clothing_clothing_pants_field_29 = object_draft_schematic_clothing_shared_clothing_pants_field_29:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Crafter\'s Pants",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s29.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_field_29, "object/draft_schematic/clothing/clothing_pants_field_29.iff")
