...
object_draft_schematic_clothing_clothing_pants_field_30 = object_draft_schematic_clothing_shared_clothing_pants_field_30:new {
   ...
   customObjectName = "Padded Workpants",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s30.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_field_30, "object/draft_schematic/clothing/clothing_pants_field_30.iff")
