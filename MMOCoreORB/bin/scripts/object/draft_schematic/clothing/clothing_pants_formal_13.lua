...
object_draft_schematic_clothing_clothing_pants_formal_13 = object_draft_schematic_clothing_shared_clothing_pants_formal_13:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Comfortable Slacks",
   ...
   targetTemplate = "object/tangible/wearables/pants/pants_s13.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_formal_13, "object/draft_schematic/clothing/clothing_pants_formal_13.iff")
