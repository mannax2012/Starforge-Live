...
object_draft_schematic_clothing_clothing_pants_formal_32 = object_draft_schematic_clothing_shared_clothing_pants_formal_32:new {
   ...
   resourceQuantities = {2, 40, 1, 3, 2},
   contribution = {100, 100, 100, 100, 100},


   targetTemplate = "object/tangible/wearables/pants/pants_s32.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_pants_formal_32, "object/draft_schematic/clothing/clothing_pants_formal_32.iff")
