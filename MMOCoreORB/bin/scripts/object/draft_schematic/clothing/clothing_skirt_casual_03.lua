...
object_draft_schematic_clothing_clothing_skirt_casual_03 = object_draft_schematic_clothing_shared_clothing_skirt_casual_03:new {
   ...
   targetTemplate = "object/tangible/wearables/skirt/skirt_s03.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_skirt_casual_03, "object/draft_schematic/clothing/clothing_skirt_casual_03.iff")
