...
object_draft_schematic_clothing_clothing_skirt_formal_06 = object_draft_schematic_clothing_shared_clothing_skirt_formal_06:new {
   ...
   targetTemplate = "object/tangible/wearables/skirt/skirt_s06.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_skirt_formal_06, "object/draft_schematic/clothing/clothing_skirt_formal_06.iff")
