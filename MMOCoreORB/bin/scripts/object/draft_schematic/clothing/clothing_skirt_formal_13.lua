...
object_draft_schematic_clothing_clothing_skirt_formal_13 = object_draft_schematic_clothing_shared_clothing_skirt_formal_13:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Thin Pleated Skirt",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_skirt_formal_13, "object/draft_schematic/clothing/clothing_skirt_formal_13.iff")
