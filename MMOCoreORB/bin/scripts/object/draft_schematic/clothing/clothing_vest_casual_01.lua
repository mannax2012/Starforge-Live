...
object_draft_schematic_clothing_clothing_vest_casual_01 = object_draft_schematic_clothing_shared_clothing_vest_casual_01:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Belted Vest",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_vest_casual_01, "object/draft_schematic/clothing/clothing_vest_casual_01.iff")
