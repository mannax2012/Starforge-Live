...
object_draft_schematic_clothing_clothing_vest_casual_10 = object_draft_schematic_clothing_shared_clothing_vest_casual_10:new {
   ...
   targetTemplate = "object/tangible/wearables/vest/vest_s10.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_vest_casual_10, "object/draft_schematic/clothing/clothing_vest_casual_10.iff")
