...
object_draft_schematic_clothing_clothing_wke_skirt_s03 = object_draft_schematic_clothing_shared_clothing_wke_skirt_s03:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Weighted Waist Wrap",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_wke_skirt_s03, "object/draft_schematic/clothing/clothing_wke_skirt_s03.iff")
