...
object_draft_schematic_droid_component_armor_module_5 = object_draft_schematic_droid_component_shared_armor_module_5:new {
   ...
   targetTemplate = "object/tangible/component/droid/armor_module_5.iff",
