...
object_draft_schematic_food_component_ingredient_carbosyrup = object_draft_schematic_food_component_shared_ingredient_carbosyrup:new {
   ...
   resourceTypes = {"flora_food"},
   resourceQuantities = {6},
   contribution = {100},
...
ObjectTemplates:addTemplate(object_draft_schematic_food_component_ingredient_carbosyrup, "object/draft_schematic/food/component/ingredient_carbosyrup.iff")
