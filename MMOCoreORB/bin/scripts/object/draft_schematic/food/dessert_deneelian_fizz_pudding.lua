...
object_draft_schematic_food_dessert_deneelian_fizz_pudding = object_draft_schematic_food_shared_dessert_deneelian_fizz_pudding:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Deneelian Fizz Pudding",
...
ObjectTemplates:addTemplate(object_draft_schematic_food_dessert_deneelian_fizz_pudding, "object/draft_schematic/food/dessert_deneelian_fizz_pudding.iff")
