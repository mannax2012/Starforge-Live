...
object_draft_schematic_food_dessert_parwan_nutricake = object_draft_schematic_food_shared_dessert_parwan_nutricake:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Parwan Nutricake",
...
ObjectTemplates:addTemplate(object_draft_schematic_food_dessert_parwan_nutricake, "object/draft_schematic/food/dessert_parwan_nutricake.iff")
