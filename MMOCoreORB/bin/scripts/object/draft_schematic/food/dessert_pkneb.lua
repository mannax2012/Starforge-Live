...
object_draft_schematic_food_dessert_pkneb = object_draft_schematic_food_shared_dessert_pkneb:new {
   ...
   targetTemplate = "object/tangible/food/crafted/dessert_pkneb.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_food_dessert_pkneb, "object/draft_schematic/food/dessert_pkneb.iff")
