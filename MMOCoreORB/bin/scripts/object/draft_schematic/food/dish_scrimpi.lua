...
object_draft_schematic_food_dish_scrimpi = object_draft_schematic_food_shared_dish_scrimpi:new {
   ...
   ingredientTitleNames = {"meat", "soypro", "water", "exotic_spices", "additive"},
...
ObjectTemplates:addTemplate(object_draft_schematic_food_dish_scrimpi, "object/draft_schematic/food/dish_scrimpi.iff")
