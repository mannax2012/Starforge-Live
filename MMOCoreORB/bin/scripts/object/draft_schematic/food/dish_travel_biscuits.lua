...
object_draft_schematic_food_dish_travel_biscuits = object_draft_schematic_food_shared_dish_travel_biscuits:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Travel Biscuits",
...
ObjectTemplates:addTemplate(object_draft_schematic_food_dish_travel_biscuits, "object/draft_schematic/food/dish_travel_biscuits.iff")
