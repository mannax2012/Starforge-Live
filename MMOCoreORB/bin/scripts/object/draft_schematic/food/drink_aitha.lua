...
object_draft_schematic_food_drink_aitha = object_draft_schematic_food_shared_drink_aitha:new {
   ...
   targetTemplate = "object/tangible/food/crafted/drink_aitha.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_food_drink_aitha, "object/draft_schematic/food/drink_aitha.iff")
