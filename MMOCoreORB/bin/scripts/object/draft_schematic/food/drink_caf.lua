...
object_draft_schematic_food_drink_caf = object_draft_schematic_food_shared_drink_caf:new {
   ...
   targetTemplate = "object/tangible/food/crafted/drink_caf.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_food_drink_caf, "object/draft_schematic/food/drink_caf.iff")
