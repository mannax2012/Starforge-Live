...
object_draft_schematic_food_drink_garrmorl = object_draft_schematic_food_shared_drink_garrmorl:new {
   ...
   targetTemplate = "object/tangible/food/crafted/drink_garrmorl.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_food_drink_garrmorl, "object/draft_schematic/food/drink_garrmorl.iff")
