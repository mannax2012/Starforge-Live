...
object_draft_schematic_food_drink_vasarian_brandy = object_draft_schematic_food_shared_drink_vasarian_brandy:new {
   ...
   targetTemplate = "object/tangible/food/crafted/drink_vasarian_brandy.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_food_drink_vasarian_brandy, "object/draft_schematic/food/drink_vasarian_brandy.iff")
