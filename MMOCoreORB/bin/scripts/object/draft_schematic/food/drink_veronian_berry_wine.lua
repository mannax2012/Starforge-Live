...
object_draft_schematic_food_drink_veronian_berry_wine = object_draft_schematic_food_shared_drink_veronian_berry_wine:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_food_drink_veronian_berry_wine, "object/draft_schematic/food/drink_veronian_berry_wine.iff")
