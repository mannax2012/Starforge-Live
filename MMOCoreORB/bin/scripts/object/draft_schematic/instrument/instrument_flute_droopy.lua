...
ObjectTemplates:addTemplate(object_draft_schematic_instrument_instrument_flute_droopy, "object/draft_schematic/instrument/instrument_flute_droopy.iff")
