...
object_draft_schematic_item_item_firework_eleven = object_draft_schematic_item_shared_item_firework_eleven:new {
   ...
   targetTemplate = "object/tangible/firework/firework_s11.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_item_item_firework_eleven, "object/draft_schematic/item/item_firework_eleven.iff")
