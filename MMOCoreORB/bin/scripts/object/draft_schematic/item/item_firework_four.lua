...
object_draft_schematic_item_item_firework_four = object_draft_schematic_item_shared_item_firework_four:new {
   ...
   targetTemplate = "object/tangible/firework/firework_s04.iff",
