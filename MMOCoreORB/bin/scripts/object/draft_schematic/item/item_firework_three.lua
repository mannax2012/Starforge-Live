...
object_draft_schematic_item_item_firework_three = object_draft_schematic_item_shared_item_firework_three:new {
   ...
   targetTemplate = "object/tangible/firework/firework_s03.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_item_item_firework_three, "object/draft_schematic/item/item_firework_three.iff")
