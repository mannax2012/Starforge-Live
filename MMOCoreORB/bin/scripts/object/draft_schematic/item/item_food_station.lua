...
object_draft_schematic_item_item_food_station = object_draft_schematic_item_shared_item_food_station:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Food and Chemical Crafting Station",
   ...
   targetTemplate = "object/tangible/crafting/station/food_station.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_item_item_food_station, "object/draft_schematic/item/item_food_station.iff")
