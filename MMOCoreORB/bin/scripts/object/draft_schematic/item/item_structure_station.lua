...
object_draft_schematic_item_item_structure_station = object_draft_schematic_item_shared_item_structure_station:new {
   ...
   customObjectName = "Structure and Furniture Crafting Station",
...
ObjectTemplates:addTemplate(object_draft_schematic_item_item_structure_station, "object/draft_schematic/item/item_structure_station.iff")
