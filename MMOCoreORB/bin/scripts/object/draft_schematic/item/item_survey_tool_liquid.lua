...
object_draft_schematic_item_item_survey_tool_liquid = object_draft_schematic_item_shared_item_survey_tool_liquid:new {
   ...
   targetTemplate = "object/tangible/survey_tool/survey_tool_liquid.iff",
