...
object_draft_schematic_item_item_survey_tool_moisture = object_draft_schematic_item_shared_item_survey_tool_moisture:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Water Survey Device",
...
ObjectTemplates:addTemplate(object_draft_schematic_item_item_survey_tool_moisture, "object/draft_schematic/item/item_survey_tool_moisture.iff")
