...
object_draft_schematic_scout_item_camokit_dathomir = object_draft_schematic_scout_shared_item_camokit_dathomir:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_scout_item_camokit_dathomir, "object/draft_schematic/scout/item_camokit_dathomir.iff")
