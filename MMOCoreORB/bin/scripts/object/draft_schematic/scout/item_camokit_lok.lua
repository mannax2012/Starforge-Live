...
object_draft_schematic_scout_item_camokit_lok = object_draft_schematic_scout_shared_item_camokit_lok:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Camo Kit: Lok",
...
ObjectTemplates:addTemplate(object_draft_schematic_scout_item_camokit_lok, "object/draft_schematic/scout/item_camokit_lok.iff")
