...
object_draft_schematic_spices_spice_giggledust = object_draft_schematic_spices_shared_spice_giggledust:new {
   ...
   resourceTypes = {"organic", "bone", "fruit_flowers"},
...
ObjectTemplates:addTemplate(object_draft_schematic_spices_spice_giggledust, "object/draft_schematic/spices/spice_giggledust.iff")
