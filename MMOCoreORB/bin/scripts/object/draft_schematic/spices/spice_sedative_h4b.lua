...
object_draft_schematic_spices_spice_sedative_h4b = object_draft_schematic_spices_shared_spice_sedative_h4b:new {
   ...
   resourceTypes = {"organic", "meat", "metal"},
...
ObjectTemplates:addTemplate(object_draft_schematic_spices_spice_sedative_h4b, "object/draft_schematic/spices/spice_sedative_h4b.iff")
