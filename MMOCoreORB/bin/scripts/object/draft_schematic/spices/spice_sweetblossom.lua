...
object_draft_schematic_spices_spice_sweetblossom = object_draft_schematic_spices_shared_spice_sweetblossom:new {
   ...
   ingredientTitleNames = {"sweetblossom_nectar", "thinner", "distilling_vat"},
