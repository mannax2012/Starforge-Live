...
object_draft_schematic_spices_spice_thruster_head = object_draft_schematic_spices_shared_spice_thruster_head:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_spices_spice_thruster_head, "object/draft_schematic/spices/spice_thruster_head.iff")
