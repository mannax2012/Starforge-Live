...
object_draft_schematic_vehicle_civilian_landspeeder_x31 = object_draft_schematic_vehicle_civilian_shared_landspeeder_x31:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "X-31 Landspeeder",
	...
	resourceQuantities = {1000, 3000, 250, 1, 1, 1},
	contribution = {100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/deed/vehicle_deed/landspeeder_x31_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_landspeeder_x31, "object/draft_schematic/vehicle/civilian/landspeeder_x31.iff")
