...
object_draft_schematic_vehicle_civilian_podracer_balta = object_draft_schematic_vehicle_civilian_shared_podracer_balta:new {
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/podracer_balta_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_podracer_balta, "object/draft_schematic/vehicle/civilian/podracer_balta.iff")
