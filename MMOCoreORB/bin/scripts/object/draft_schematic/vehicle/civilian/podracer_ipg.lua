...
object_draft_schematic_vehicle_civilian_podracer_ipg = object_draft_schematic_vehicle_civilian_shared_podracer_ipg:new {
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/podracer_ipg_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_podracer_ipg, "object/draft_schematic/vehicle/civilian/podracer_ipg.iff")
