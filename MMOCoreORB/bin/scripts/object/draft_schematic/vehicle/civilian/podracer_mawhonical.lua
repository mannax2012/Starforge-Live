...
object_draft_schematic_vehicle_civilian_podracer_mawhonical = object_draft_schematic_vehicle_civilian_shared_podracer_mawhonical:new {
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/podracer_mawhonical_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_podracer_mawhonical, "object/draft_schematic/vehicle/civilian/podracer_mawhonical.iff")
