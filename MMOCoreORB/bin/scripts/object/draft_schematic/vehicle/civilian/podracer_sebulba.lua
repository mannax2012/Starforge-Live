...
object_draft_schematic_vehicle_civilian_podracer_sebulba = object_draft_schematic_vehicle_civilian_shared_podracer_sebulba:new {
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/podracer_sebulba_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_podracer_sebulba, "object/draft_schematic/vehicle/civilian/podracer_sebulba.iff")
