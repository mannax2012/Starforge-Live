...
object_draft_schematic_vehicle_civilian_speederbike_flash = object_draft_schematic_vehicle_civilian_shared_speederbike_flash:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Flash Speeder",
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/speederbike_flash_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_speederbike_flash, "object/draft_schematic/vehicle/civilian/speederbike_flash.iff")
