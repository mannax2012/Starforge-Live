...
object_draft_schematic_vehicle_component_enhanced_chipset = object_draft_schematic_vehicle_component_shared_enhanced_chipset:new {
	...
	resourceTypes = {"copper_codoan", "ore_intrusive", "petrochem_inert_polymer"},
...
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_component_enhanced_chipset, "object/draft_schematic/vehicle/component/enhanced_chipset.iff")
