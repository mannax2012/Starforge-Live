...
object_draft_schematic_vehicle_component_injector_assembly_advanced = object_draft_schematic_vehicle_component_shared_injector_assembly_advanced:new {
    
	templateType = DRAFTSCHEMATIC,

	customObjectName = "Injector Assembly: Advanced",
	...
	targetTemplate = "object/tangible/component/vehicle/injector_assembly_advanced.iff",

	additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_vehicle_component_injector_assembly_advanced, "object/draft_schematic/vehicle/component/injector_assembly_advanced.iff")
