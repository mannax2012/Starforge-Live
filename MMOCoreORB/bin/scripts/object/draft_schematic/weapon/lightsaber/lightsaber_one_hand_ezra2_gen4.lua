...
object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_ezra2_gen4 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_one_hand_ezra2_gen4:new {
   ...
   targetTemplate = "object/weapon/melee/sword/crafted_saber/sword_lightsaber_one_handed_ezra2_gen4.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_ezra2_gen4, "object/draft_schematic/weapon/lightsaber/lightsaber_one_hand_ezra2_gen4.iff")
