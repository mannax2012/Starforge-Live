...
object_draft_schematic_weapon_lightsaber_lightsaber_polearm_cal_gen3 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_polearm_cal_gen3:new {
   ...
   targetTemplate = "object/weapon/melee/polearm/crafted_saber/sword_lightsaber_polearm_cal_gen3.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_polearm_cal_gen3, "object/draft_schematic/weapon/lightsaber/lightsaber_polearm_cal_gen3.iff")
