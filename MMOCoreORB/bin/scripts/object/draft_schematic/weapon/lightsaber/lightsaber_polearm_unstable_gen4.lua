...
object_draft_schematic_weapon_lightsaber_lightsaber_polearm_unstable_gen4 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_polearm_unstable_gen4:new {
   ...
   targetTemplate = "object/weapon/melee/polearm/crafted_saber/sword_lightsaber_polearm_unstable_gen4.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_polearm_unstable_gen4, "object/draft_schematic/weapon/lightsaber/lightsaber_polearm_unstable_gen4.iff")
