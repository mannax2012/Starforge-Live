...
object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_ezra_gen3 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_two_hand_ezra_gen3:new {
   ...
   targetTemplate = "object/weapon/melee/2h_sword/crafted_saber/sword_lightsaber_two_handed_ezra_gen3.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_ezra_gen3, "object/draft_schematic/weapon/lightsaber/lightsaber_two_hand_ezra_gen3.iff")
