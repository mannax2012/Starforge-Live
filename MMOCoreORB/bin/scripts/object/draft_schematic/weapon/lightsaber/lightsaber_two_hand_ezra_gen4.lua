...
object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_ezra_gen4 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_two_hand_ezra_gen4:new {
   ...
   targetTemplate = "object/weapon/melee/2h_sword/crafted_saber/sword_lightsaber_two_handed_ezra_gen4.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_ezra_gen4, "object/draft_schematic/weapon/lightsaber/lightsaber_two_hand_ezra_gen4.iff")
