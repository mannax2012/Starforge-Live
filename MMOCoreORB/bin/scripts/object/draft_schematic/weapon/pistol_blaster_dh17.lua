...
object_draft_schematic_weapon_pistol_blaster_dh17 = object_draft_schematic_weapon_shared_pistol_blaster_dh17:new {
   ...
   targetTemplate = "object/weapon/ranged/pistol/pistol_dh17.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_pistol_blaster_dh17, "object/draft_schematic/weapon/pistol_blaster_dh17.iff")
