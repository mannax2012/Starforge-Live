...
object_draft_schematic_weapon_rifle_blaster_cdef = object_draft_schematic_weapon_shared_rifle_blaster_cdef:new {
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_cdef.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_blaster_cdef, "object/draft_schematic/weapon/rifle_blaster_cdef.iff")
