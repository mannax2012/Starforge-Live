...
object_draft_schematic_weapon_rifle_blaster_dlt20 = object_draft_schematic_weapon_shared_rifle_blaster_dlt20:new {
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_dlt20.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_blaster_dlt20, "object/draft_schematic/weapon/rifle_blaster_dlt20.iff")
