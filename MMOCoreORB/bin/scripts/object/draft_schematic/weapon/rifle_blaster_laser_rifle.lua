...
object_draft_schematic_weapon_rifle_blaster_laser_rifle = object_draft_schematic_weapon_shared_rifle_blaster_laser_rifle:new {
   ...
   resourceQuantities = {35, 65, 15, 3, 1, 1, 1},
   contribution = {100, 100, 100, 100, 100, 100, 100},
   ingredientAppearance = {"", "", "", "", "muzzle", "scope", "stock"},


   targetTemplate = "object/weapon/ranged/rifle/rifle_laser.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_blaster_laser_rifle, "object/draft_schematic/weapon/rifle_blaster_laser_rifle.iff")
