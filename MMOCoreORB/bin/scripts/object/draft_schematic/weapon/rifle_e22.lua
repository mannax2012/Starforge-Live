...
object_draft_schematic_weapon_rifle_e22 = object_draft_schematic_weapon_shared_rifle_e22:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "e22 Rifle",
   ...
   targetTemplate = "object/weapon/ranged/rifle/rifle_e22.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_e22, "object/draft_schematic/weapon/rifle_e220.iff")
