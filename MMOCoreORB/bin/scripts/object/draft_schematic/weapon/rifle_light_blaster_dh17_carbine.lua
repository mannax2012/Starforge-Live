...
object_draft_schematic_weapon_rifle_light_blaster_dh17_carbine = object_draft_schematic_weapon_shared_rifle_light_blaster_dh17_carbine:new {
   ...
   targetTemplate = "object/weapon/ranged/carbine/carbine_dh17.iff",

   additionalTemplates = {}

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_light_blaster_dh17_carbine, "object/draft_schematic/weapon/rifle_light_blaster_dh17_carbine.iff")
