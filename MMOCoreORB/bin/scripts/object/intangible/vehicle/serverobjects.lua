...
includeFile("intangible/vehicle/podracer_sebulba_pcd.lua")
includeFile("intangible/vehicle/podracer_fg_8t8_pcd.lua")
includeFile("intangible/vehicle/podracer_ipg_pcd.lua")
includeFile("intangible/vehicle/podracer_balta_pcd.lua")
includeFile("intangible/vehicle/podracer_gasgano_pcd.lua")
includeFile("intangible/vehicle/podracer_mawhonical_pcd.lua")
