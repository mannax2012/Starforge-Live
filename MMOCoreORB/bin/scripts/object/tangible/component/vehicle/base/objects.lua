...
ObjectTemplates:addClientTemplate(object_tangible_component_vehicle_base_shared_base_vehicle, 
"object/tangible/component/vehicle/base/shared_base_vehicle.iff")
