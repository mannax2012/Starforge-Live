...
object_tangible_component_vehicle_fuel_sublimator = object_tangible_component_vehicle_shared_fuel_sublimator:new {
	...
	experimentalMin = {0, 0, -75, 1, -2.5, 0},
	experimentalMax = {0, 0, -25, 2, 0, 0.66},
	experimentalPrecision = {0, 0, 0, 2, 1, 2},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_vehicle_fuel_sublimator, "object/tangible/component/vehicle/fuel_sublimator.iff")
