...
object_tangible_component_vehicle_hydraulic_actuator = object_tangible_component_vehicle_shared_hydraulic_actuator:new {
	...
	experimentalMin = {0, 0, -125, 2, -2.5, -0.66},
	experimentalMax = {0, 0, -175, 3, 0, 0},
	experimentalPrecision = {0, 0, 0, 2, 1, 2},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_vehicle_hydraulic_actuator, "object/tangible/component/vehicle/hydraulic_actuator.iff")
