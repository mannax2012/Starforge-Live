...
object_tangible_component_vehicle_hyper_accelerometer = object_tangible_component_vehicle_shared_hyper_accelerometer:new {
...
ObjectTemplates:addTemplate(object_tangible_component_vehicle_hyper_accelerometer, "object/tangible/component/vehicle/hyper_accelerometer.iff")
