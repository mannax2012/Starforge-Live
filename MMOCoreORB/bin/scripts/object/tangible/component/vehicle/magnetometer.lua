...
object_tangible_component_vehicle_magnetometer = object_tangible_component_vehicle_shared_magnetometer:new {
	...
	experimentalMin = {0, 0, -75, 0, 2.5, 0},
	experimentalMax = {0, 0, -125, 1, 5, 0.66},
	experimentalPrecision = {0, 0, 0, 2, 1, 2},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_vehicle_magnetometer, "object/tangible/component/vehicle/magnetometer.iff")
