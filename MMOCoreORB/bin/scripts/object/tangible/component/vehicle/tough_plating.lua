...
object_tangible_component_vehicle_tough_plating = object_tangible_component_vehicle_shared_tough_plating:new {
	
	numberExperimentalProperties = {1, 1, 3, 3, 3, 3, 3},
	experimentalProperties = {"XX", "XX", "OQ", "SR", "UT", "OQ", "SR", "UT", "OQ", "DR", "MA", "OQ", "SR", "MA", "OQ", "DR", "SR"},
...
ObjectTemplates:addTemplate(object_tangible_component_vehicle_tough_plating, "object/tangible/component/vehicle/tough_plating.iff")
