...
object_tangible_deed_vehicle_deed_flare_s_swoop_deed = object_tangible_deed_vehicle_deed_shared_flare_s_swoop_deed:new {
...
ObjectTemplates:addTemplate(object_tangible_deed_vehicle_deed_flare_s_swoop_deed, "object/tangible/deed/vehicle_deed/flare_s_swoop_deed.iff")
