...
object_tangible_deed_vehicle_deed_podracer_gasgano_deed = object_tangible_deed_vehicle_deed_shared_podracer_gasgano_deed:new {

	templateType = VEHICLEDEED,

	controlDeviceObjectTemplate = "object/intangible/vehicle/podracer_gasgano_pcd.iff",
...
ObjectTemplates:addTemplate(object_tangible_deed_vehicle_deed_podracer_gasgano_deed, "object/tangible/deed/vehicle_deed/podracer_gasgano_deed.iff")
