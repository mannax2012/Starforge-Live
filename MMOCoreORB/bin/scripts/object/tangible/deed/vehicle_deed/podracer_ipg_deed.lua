...
object_tangible_deed_vehicle_deed_podracer_ipg_deed = object_tangible_deed_vehicle_deed_shared_podracer_ipg_deed:new {

	templateType = VEHICLEDEED,

	controlDeviceObjectTemplate = "object/intangible/vehicle/podracer_ipg_pcd.iff",
	generatedObjectTemplate = "object/mobile/vehicle/podracer_ipg.iff",
...
ObjectTemplates:addTemplate(object_tangible_deed_vehicle_deed_podracer_ipg_deed, "object/tangible/deed/vehicle_deed/podracer_ipg_deed.iff")
