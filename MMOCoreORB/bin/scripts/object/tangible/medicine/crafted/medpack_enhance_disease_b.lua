...
object_tangible_medicine_crafted_medpack_enhance_disease_b = object_tangible_medicine_crafted_shared_medpack_enhance_disease_b:new {
	gameObjectType = 8238,
	...
	experimentalMax = {0, 0, 160, 20, 14200, 90, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 4},
}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_enhance_disease_b, "object/tangible/medicine/crafted/medpack_enhance_disease_b.iff")
