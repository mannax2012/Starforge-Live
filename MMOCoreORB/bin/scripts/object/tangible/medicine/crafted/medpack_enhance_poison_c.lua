...
object_tangible_medicine_crafted_medpack_enhance_poison_c = object_tangible_medicine_crafted_shared_medpack_enhance_poison_c:new {
	gameObjectType = 8238,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_enhance_poison_c, "object/tangible/medicine/crafted/medpack_enhance_poison_c.iff")
