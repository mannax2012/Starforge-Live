...
object_tangible_wearables_backpack_backpack_starforge = object_tangible_wearables_backpack_shared_backpack_starforge:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_backpack_backpack_starforge, "object/tangible/wearables/backpack/starforge_backpack.iff")
