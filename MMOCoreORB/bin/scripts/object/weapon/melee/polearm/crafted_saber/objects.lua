...
object_weapon_melee_polearm_crafted_saber_shared_sword_lightsaber_polearm_cal_gen3 = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/melee/polearm/crafted_saber/shared_sword_lightsaber_polearm_cal_gen3.iff"}
ObjectTemplates:addClientTemplate(object_weapon_melee_polearm_crafted_saber_shared_sword_lightsaber_polearm_cal_gen3, 
"object/weapon/melee/polearm/crafted_saber/shared_sword_lightsaber_polearm_cal_gen3.iff")

object_weapon_melee_polearm_crafted_saber_shared_sword_lightsaber_polearm_cal_gen4 = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/melee/polearm/crafted_saber/shared_sword_lightsaber_polearm_cal_gen4.iff"}
ObjectTemplates:addClientTemplate(object_weapon_melee_polearm_crafted_saber_shared_sword_lightsaber_polearm_cal_gen4, 
"object/weapon/melee/polearm/crafted_saber/shared_sword_lightsaber_polearm_cal_gen4.iff")
