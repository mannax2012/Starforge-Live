...
object_weapon_ranged_grenade_grenade_fragmentation = object_weapon_ranged_grenade_shared_grenade_fragmentation:new {
	...
	certificationsRequired = { "cert_grenade_fragmentation" },
	...
	experimentalMin = {0, 0, 200, 400, 4.5, 7, 1000, -16, -45, 0, 10, 64, 0, 280, 0},
	experimentalMax = {0, 0, 296, 1450, 3.5, 13, 1000, 14, 15, 30, 30, 64, 0, 350, 0},
