...
object_weapon_ranged_grenade_grenade_imperial_detonator = object_weapon_ranged_grenade_shared_grenade_imperial_detonator:new {
	...
	certificationsRequired = { "cert_grenade_imperial_detonator" },
	...
	experimentalMin = {0, 0, 645, 1300, 6, 7, 1000, -16, -45, 0, 10, 64, 0, 280, 0},
	experimentalMax = {0, 0, 989, 2000, 2.5, 13, 1000, 14, -15, 30, 30, 64, 0, 350, 0},
